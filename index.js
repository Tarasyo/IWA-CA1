...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('games.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('games.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('games.xml', function(err, result) {
      ...
      result.nintendo.games[obj.sec_n].game.push({'name': obj.name, 'publisher': obj.publisher, 'release': obj.release, 'director': obj.director, 'rank': obj.rank}); //If your XML elements are differet, this is where you have to change to your own element names
